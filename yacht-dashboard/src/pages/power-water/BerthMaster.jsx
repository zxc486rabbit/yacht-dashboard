...
export default function BerthMaster() {
  ...
  const toggleEnabled = (row) => {
    setBerths((prev) =>
      prev.map((b) =>
        b.id === row.id ? { ...b, enabled: !b.enabled, updatedAt: nowISO() } : b
      )
    );
  };
                  ...
                  <tr key={row.id}>
                    ...
                    <td className="text-center">
                      <div className="d-flex flex-wrap gap-2 justify-content-center">
                        <Link className="btn btn-outline-primary btn-sm"  to={`/realtime?dock=${row.berthNo}`}>
                          即時
                        </Link>
                        <Link className="btn btn-outline-primary btn-sm" to="/remote-control">
                          遠控
                        </Link>
                        <Link className="btn btn-outline-primary btn-sm" to="/history">
                          歷史
                        </Link>
                        <Link className="btn btn-outline-danger btn-sm" to="/alarm-center">
                          告警
                        </Link>
                      </div>
                    </td>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="d-flex flex-wrap gap-2">
                  <Link className="btn btn-outline-primary btn-sm" to="/realtime">
                    前往即時監控
                  </Link>
                  <Link className="btn btn-outline-primary btn-sm" to="/remote-control">
                    前往遠端控管
